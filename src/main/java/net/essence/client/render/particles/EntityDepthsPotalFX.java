...
public class EntityDepthsPotalFX extends EntityFX
{
    ...
    public EntityDepthsPotalFX(final World var1, final double var2, final double var4, final double var6, final double var8, final double var10, final double var12) {
        ...
        this.particleBlue = 1.0f * this.rand.nextFloat();
        this.particleGreen = 1.0f * this.rand.nextFloat();
        this.particleRed = 1.0f * this.rand.nextFloat();
