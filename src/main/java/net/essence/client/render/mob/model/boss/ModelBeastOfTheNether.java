...
public class ModelBeastOfTheNether extends ModelBase
{
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        ...
        this.RightHornBase.rotateAngleY = par4 / 57.295776f;
        this.RightHornBase.rotateAngleX = par5 / 57.295776f;
        this.RightHorn.rotateAngleY = par4 / 57.295776f;
        this.RightHorn.rotateAngleX = par5 / 57.295776f;
        this.LeftHornBase.rotateAngleY = par4 / 57.295776f;
        this.LeftHornBase.rotateAngleX = par5 / 57.295776f;
        this.LeftHorn.rotateAngleY = par4 / 57.295776f;
        this.LeftHorn.rotateAngleX = par5 / 57.295776f;
        this.BackRightLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662f + 3.1415927f) * 2.0f * par2 * 0.5f;
        ...
        this.FrontRightLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662f + 3.1415927f) * 1.4f * par2;
    }
}
